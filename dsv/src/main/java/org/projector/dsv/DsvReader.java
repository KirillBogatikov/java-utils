...
public class DsvReader {
    ...
    public DsvReader(Reader reader, DsvDeserializer deserializer) {
        checkNotNull(reader, "Writer");
        this.reader = reader;
        setDeserializer(deserializer);
    }

    public DsvReader(InputStream stream, DsvDeserializer deserializer) {
    ...
    public void setDeserializer(DsvDeserializer deserializer) {
        if (deserializer == null) {
            this.deserializer = new SimpleDeserializer(SimpleDeserializer.COMMA);
        } else {
